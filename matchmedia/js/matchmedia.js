...
window.matchMedia = window.matchMedia || (function (doc, window) {
  ...
  MediaQueryList.prototype = {
     ...
     *   matches property is true when the media query applies and false when
     *   not. The original media query is referenced in the media property.
     */
    addListener: function (callback) {
      ...
      x = window.addEventListener('resize', handler);
      x = window.addEventListener('orientationchange', handler);
    },
    /**
